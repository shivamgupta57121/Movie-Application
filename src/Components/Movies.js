...
export default class Movies extends Component {
    ...
    // To update current search text in state
    handleChange = (e) => {
    ...
    // To update limit in state
    handlePageLimitChange = (e) => {
        let newLimit = e.target.value;
        console.log(newLimit);
        if (newLimit < 1) {
            alert('Limit should be greater than 0.');
            newLimit = 4;
        }
        this.setState({
            limit: newLimit
    ...
    // For sorting on basis of Ratings
    sortByRatings = (e) => {
    ...
    render() {
        ...
        // To reset page to first if all elements deleted from last page
                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-9'>
                                ...
                                <input type='number' value={this.state.limit} onChange={this.handlePageLimitChange} ></input>
